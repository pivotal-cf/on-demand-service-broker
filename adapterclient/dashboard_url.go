...
func (a *Adapter) GenerateDashboardUrl(instanceID string, plan sdk.Plan, manifest []byte, logger *log.Logger) (string, error) {
	...
	stdout, stderr, exitCode, err := a.CommandRunner.Run(a.ExternalBinPath, "dashboard-url", instanceID, string(planJSON), string(manifest))
	if err != nil {
