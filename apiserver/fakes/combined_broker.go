...
func (fake *FakeCombinedBroker) Upgrade(arg1 context.Context, arg2 string, arg3 domain.UpdateDetails, arg4 *log.Logger) (broker.OperationData, string,map[string]interface{}, error) {
...
func (fake *FakeCombinedBroker) UpgradeCalls(stub func(context.Context, string, domain.UpdateDetails, *log.Logger) (broker.OperationData, string,map[string]interface{}, error)) {
	fake.upgradeMutex.Lock()
...
func (fake *FakeCombinedBroker) UpgradeReturns(result1 broker.OperationData, result2 string,result4 map[string]interface{}, result3 error) {
	fake.upgradeMutex.Lock()
	defer fake.upgradeMutex.Unlock()
	...
	fake.upgradeReturns = struct {
		...
		result4 map[string]interface{}
		result3 error
	}{result1, result2, result4,result3}
}

func (fake *FakeCombinedBroker) UpgradeReturnsOnCall(i int, result1 broker.OperationData, result2 string,result4 map[string]interface{}, result3 error) {
	fake.upgradeMutex.Lock()
	defer fake.upgradeMutex.Unlock()
	fake.UpgradeStub = nil
