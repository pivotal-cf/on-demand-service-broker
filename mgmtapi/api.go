...
type ManageableBroker interface {
	...
	Upgrade(ctx context.Context, instanceID string, updateDetails domain.UpdateDetails, logger *log.Logger) (broker.OperationData, string, map[string]interface{}, error)
