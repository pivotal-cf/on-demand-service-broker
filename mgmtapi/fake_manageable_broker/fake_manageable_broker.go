...
type FakeManageableBroker struct {
	...
	UpgradeStub        func(context.Context, string, domain.UpdateDetails, *log.Logger) (broker.OperationData, string, map[string]interface{}, error)
...
func (fake *FakeManageableBroker) Upgrade(arg1 context.Context, arg2 string, arg3 domain.UpdateDetails, arg4 *log.Logger) (broker.OperationData, string, map[string]interface{}, error) {
	...
	if specificReturn {
		return ret.result1, ret.result2, ret.result4,ret.result3
	}
	return fakeReturns.result1, fakeReturns.result2,fakeReturns.result4, fakeReturns.result3
}
...
func (fake *FakeManageableBroker) UpgradeCalls(stub func(context.Context, string, domain.UpdateDetails, *log.Logger) (broker.OperationData, string, map[string]interface{}, error)) {
	fake.upgradeMutex.Lock()
...
func (fake *FakeManageableBroker) UpgradeReturns(result1 broker.OperationData, result2 string, result4  map[string]interface{}, result3 error) {
	fake.upgradeMutex.Lock()
	defer fake.upgradeMutex.Unlock()
...
func (fake *FakeManageableBroker) UpgradeReturnsOnCall(i int, result1 broker.OperationData, result2 string, result4  map[string]interface{},result3 error) {
	fake.upgradeMutex.Lock()
	defer fake.upgradeMutex.Unlock()
	fake.UpgradeStub = nil
